...
def normalized_target(name: str) -> PurePosixPath | None:
    ...
    if parts and parts[0] in {"Surge", "Surge-R10-Candidate", "Surge-R12-Candidate", "Surge-R12.14-Candidate", "Surge-R12.15-Candidate", "Surge-R12.16-Candidate", "Surge-R12.17-Candidate", "Surge-R13.1-Candidate", "Surge-R13.2-Candidate", "Surge-R13.3-Candidate", "Surge-R13.4-Candidate", "Surge-R13.5-Candidate", "Surge-R13.6-Candidate"}:
        parts.pop(0)
    if not parts:
        return None
