#!/usr/bin/env python3
"""Single strict inventory for every R13.25 release producer and verifier."""
...
TOOL_FILES = {
    ...
    "test_runtime_rules.py", "test_policy_failover.py",
...
TRANSIENT_ARCHIVES = {
    ...
    PurePosixPath("Surge-R13.5-Complete-No-Embedded-20260829.zip"),
    ...
    PurePosixPath("Surge-R13.13-Complete-No-Embedded-20260901.zip"),
    PurePosixPath("Surge-R13.16-Complete-No-Embedded-20260901.zip"),
    PurePosixPath("Surge-R13.17-Complete-No-Embedded-20260902.zip"),
    PurePosixPath("Surge-R13.19-External-Rules-20260907.zip"),
    PurePosixPath("Surge-R13.20-External-Rules-20260908.zip"),
    PurePosixPath("Surge-R13.21-External-Rules-20260908.zip"),
    PurePosixPath("Surge-R13.23-External-Rules-20260908.zip"),
    PurePosixPath("Surge-R13.25-External-Rules-20260909.zip"),
}
