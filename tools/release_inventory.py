#!/usr/bin/env python3
"""Single strict inventory for every R13.18 release producer and verifier."""
...
TOOL_FILES = {
    ...
    "embed_runtime_rules.py", "test_embed_runtime_rules.py",
...
TRANSIENT_ARCHIVES = {
    ...
    PurePosixPath("Surge-R13.18-Single-File-20260907.zip"),
}
