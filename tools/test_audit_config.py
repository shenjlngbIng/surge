...
replace_once("bilibili_hotfix_header", "# > Hotfix: BiliBili domestic traffic stays DIRECT and cannot inherit a stale hidden Domestic selection.\n", "")
...
swap_once("bili_precedence", rr("RULE-SET", "BiliBiliIntl.list", "Streaming"), rr("RULE-SET", "BiliBili.list", "DIRECT"))
