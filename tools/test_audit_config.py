...
replace_once("routing_header", "# > Routing review based on R13.4; domestic apps stay local and region-limited services use supported exits by default.\n", "")
replace_once("bilibili_header", "# > BiliBili domestic HTTPDNS is protected from ad-list false positives; the international-edition ruleset is retired.\n", "")
...
replace_once("service_direct", "ChatGPT = select, Japan, Singapore", "ChatGPT = select, DIRECT, Singapore")
replace_once("chatgpt_unsupported_default", "ChatGPT = select, Japan, Singapore", "ChatGPT = select, HongKong, Singapore")
replace_once("claude_unsupported_default", "Claude = select, Japan, Singapore", "Claude = select, HongKong, Singapore")
replace_once("gemini_unsupported_default", "Gemini = select, Japan, Singapore", "Gemini = select, HongKong, Singapore")
replace_once("tiktok_unsupported_default", "TikTok = select, Japan, Singapore", "TikTok = select, HongKong, Singapore")
replace_once("bahamut_default", "Bahamut = select, TaiWan, HongKong", "Bahamut = select, Proxy, HongKong")
...
replace_once("undefined_group", "Claude = select, Japan, Singapore", "Claude = select, MissingPolicy, Singapore")
...
replace_once("bili_policy", rr("RULE-SET", "BiliBili.list", "DIRECT"), rr("RULE-SET", "BiliBili.list", "Domestic"))
replace_once("bili_httpdns_policy", "DOMAIN,httpdns.bilivideo.com,DIRECT", "DOMAIN,httpdns.bilivideo.com,AdBlock")
replace_once("bili_intl_guard_policy", "DOMAIN,apiintl.biliapi.net,Proxy", "DOMAIN,apiintl.biliapi.net,DIRECT")
replace_once("bili_intl_ruleset", rr("RULE-SET", "BiliBili.list", "DIRECT"), rr("RULE-SET", "BiliBiliIntl.list", "Streaming") + "\n" + rr("RULE-SET", "BiliBili.list", "DIRECT"))
...
swap_once("bili_httpdns_precedence", "DOMAIN,httpdns.bilivideo.com,DIRECT", rr("RULE-SET", "Ads.list", "AdBlock"))
swap_once("bili_guard_contiguity", "DOMAIN,p-bstarstatic.akamaized.net,Proxy", "DOMAIN,p.bstarstatic.com,Proxy")
