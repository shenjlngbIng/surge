#!/usr/bin/env python3
"""Validate the R13.9 external runtime-rule inventory.
...
PROFILE_NAME = "Surge iOS Privacy + Push R13.9 Smart Diagnostics"
...
def main() -> int:
    ...
    if external != expected_remote_order():
        raise SystemExit("runtime rule inventory or order differs from the reviewed R13.9 inventory")
