#!/usr/bin/env python3
"""Validate the R13.12 external runtime-rule inventory.
...
PROFILE_NAME = "Surge iOS Privacy + Push R13.12 Real Proxy Diagnostics"
...
def main() -> int:
    ...
    if external != expected_remote_order():
        raise SystemExit("runtime rule inventory or order differs from the reviewed R13.12 inventory")
